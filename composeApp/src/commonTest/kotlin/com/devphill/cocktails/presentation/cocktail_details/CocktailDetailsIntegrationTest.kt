...
class CocktailDetailsIntegrationTest {
    ...
    fun uiStateTransitionsValidation() {
        ...
        val favoriteToggledState = successState.copy(
    ...
    fun dataConsistencyAcrossDifferentCocktailTypes() {
        sampleCocktails.forEach { cocktail ->
            ...
            val complexityFormatted = cocktail.complexity.name.lowercase()
                .replaceFirstChar { it.uppercaseChar() }
            val strengthFormatted = cocktail.alcoholStrength.name.lowercase()
                .replace("_", " ").split(" ")
    ...
    fun nullValueHandlingAcrossComponents() {
        val cocktailWithNulls = sampleCocktails[0].copy(
            imageUrl = null,
            cocktailUrl = null,
            views = null,
            garnish = null,

...
/**
 * Custom Typography system for the Cocktails app
 * This defines all text styles with proper colors that work with both light and dark themes
 */
object CocktailsTypography {
    ...
    fun create(): Typography = Typography(
        ...
        // Title styles - for card titles, section headings like "All Cocktails"
        ...
        // Label styles - for buttons, tabs, small labels

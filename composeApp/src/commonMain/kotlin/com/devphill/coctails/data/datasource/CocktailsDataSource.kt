...
import com.devphill.coctails.data.parser.CocktailsJsonParserImpl
import com.devphill.coctails.data.resource.PlatformResourceLoader
        ...
        return loadCocktailsDatabase().map { database ->
            database.cocktails.map { cocktailDetail ->
                ...
                Cocktail(
                    ...
                    complexity = com.devphill.coctails.domain.model.ComplexityLevel.fromString(cocktailDetail.complexity),
                    alcoholStrength = com.devphill.coctails.domain.model.AlcoholStrength.fromString(cocktailDetail.alcoholStrength),
